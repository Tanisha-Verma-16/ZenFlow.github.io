...
const initAbout = () => {
  ...
  const articleContent = [
    "Our quality of life is directly linked to our mental health. Prioritizing mental well-being leads to greater satisfaction, fulfillment, and resilience in the face of challenges.",

    "By openly addressing mental health, we help reduce stigma and encourage others to seek support when needed. This fosters a culture of acceptance, understanding, and empathy toward mental health challenges.",

    "Mental health also plays a crucial role in forming and maintaining positive relationships. Prioritizing mental well-being fosters healthier connections and supportive environments that promote growth and happiness.",
  ];
...
const initWelcomePage = () => {
  ...
  const registerButton = appendElem(
    regWrapper,
    "div",
    ["action-button"],
    "Let's get going!"
